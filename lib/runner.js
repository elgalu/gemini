...
module.exports = inherit(QEmiiter, {
    ...
    run: function(suites) {
        ...
        return this.emitAndWait(RunnerEvents.BEGIN, {
            config: _this.config,
            ...
            return _this._runSession(suites);
        })
        .then(function() {
    ...
    _runSession: function(suites) {
        ...
        return this._beginSession()
            ...
            .then(function () {
                return _this._endSession();
            })
    },

    _beginSession: function() {
        console.log('begin new session');
        return this.emitAndWait(RunnerEvents.BEGIN_SESSION);
    },

    _endSession: function () {
        console.log('end new session');
        return this.emitAndWait(RunnerEvents.END_SESSION);
    },
    ...
    _runSuitesInBrowser: function(suites, browserId) {
        console.log('run suites in browser');
        var _this = this,
    ...
    _tryToRunSuiteInBrowser: function(suite, browserId, retryCount) {
        console.log('try to run suite in browser');
        var _this = this;
        ...
        return _this.browserPool.getBrowser(browserId)
            ...
            .fail(function(e) {
                console.log('try to run suite in browser error:');
                console.log(e);
    ...
    _runSuiteInBrowser: function(suite, browser) {
        console.log('run suite in browser');
        if (this._cancelled) {
            return q.resolve();
        }
